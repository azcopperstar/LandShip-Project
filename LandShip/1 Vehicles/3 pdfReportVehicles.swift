...
struct pdfReportVehicles: View {
	// Fetch the vehicles we will render into the PDF
	...
	// MARK: - Column content model
	struct ColumnContent {
		var text: String
		var imageData: Data? = nil
	}

	// Produce the values for a vehicle record
	// Columns: IMAGE, NAME, VEHICLE DETAILS, ODOM(VIRTUAL), ENG HRS, FUEL TYPE, ENGINE/TRANS, VIN/PLATE, NOTES
...
// A small preview host that seeds an in-memory SwiftData container in init,
// keeping the preview ViewBuilder free of side-effect statements.
