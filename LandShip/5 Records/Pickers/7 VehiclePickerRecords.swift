...
struct VehiclePickerRecords: View {
	...
	var body: some View {
		...
		InnerViewRecords_Vehicle(RequestingModel: RequestingModel, RequestingData: $RequestingData)
	}
}

struct InnerViewRecords_Vehicle: View {
...
//				.tag("All Vehicles")
		...
		.onChange(of: selectedPicker) {oldValue, newValue in
			print("RequestingData.part1: \(selectedPicker)")
			print("RequestingData.part1: \(String(describing: selectedPicker))")
