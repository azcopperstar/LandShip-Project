...
struct VendorPickerRecords: View {
	...
	var body: some View {
		...
		InnerViewRecords_Vendor(RequestingModel: RequestingModel, RequestingData: $RequestingData)
	}
}

struct InnerViewRecords_Vendor: View {
