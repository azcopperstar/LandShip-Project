...
struct pdfReportTrip: View {
	// Fetch the trip log entries we will render into the PDF
	...
	// Produce the 11 column strings for a record (Locations combined, Fuel Levels combined)
	...
	// Compute raw metrics for totals
	...
	// Draw a totals row with duration, distance and fuel consumed
