...
struct VehiclePickerTripLog: View {
	...
	var body: some View {
		...
		InnerViewTripLog_Vehicle(RequestingModel: RequestingModel, RequestingData: $RequestingData)
	}
}

struct InnerViewTripLog_Vehicle: View {
